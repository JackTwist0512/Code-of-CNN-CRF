...
def main(m_class, train_num):
    ...
    if train:
        ...
        model = unet()
        model_path = test_path + "/model/"+type+"_binception3_all3"
        makedir(model_path)
        ...
        training_vis(history,test_path + "/model/"+type+"_binception3_all3/loss&acc" + str(n) + ".jpg")
    ...
    if predict:
        ...
        predict_save_path = test_path + "/predict/"+ type+"_binception3_all3/" + str(n)
        makedir(predict_save_path)
        saveResult(predict_save_path, results)
        test_end = time.clock()
    time1 = train_end - start
    time2 = test_end - train_end
    print("training_time:",time1)
    print("testing_time:",time2)