...
def unet(pretrained_weights = None,input_size=(256,256,1)):
    ...
    conv2 = Conv2D(16, (5, 5), padding='same', kernel_initializer='he_normal')(inputs)
    conv2_1 = BatchNormalization()(conv2)
    conv2_2 = Activation('relu')(conv2_1)
    conv3 = Conv2D(16, (7, 7), padding='same', kernel_initializer='he_normal')(inputs)
    ...
    conv6 = Conv2D(32, (5, 5), padding='same', kernel_initializer='he_normal')(down1)
    conv6_1 = BatchNormalization()(conv6)
    conv6_2 = Activation('relu')(conv6_1)
    conv7 = Conv2D(32, (7, 7), padding='same', kernel_initializer='he_normal')(down1)
    ...
    conv10 = Conv2D(64, (5, 5), padding='same', kernel_initializer='he_normal')(down2)
    conv10_1 = BatchNormalization()(conv10)
    conv10_2 = Activation('relu')(conv10_1)
    conv11 = Conv2D(64, (7, 7), padding='same', kernel_initializer='he_normal')(down2)
    ...
    conv14 = Conv2D(128, (5, 5), padding='same', kernel_initializer='he_normal')(down3)
    conv14_1 = BatchNormalization()(conv14)
    conv14_2 = Activation('relu')(conv14_1)
    conv15 = Conv2D(128, (7, 7), padding='same', kernel_initializer='he_normal')(down3)
    ...
    conv18 = Conv2D(256, (5, 5), padding='same', kernel_initializer='he_normal')(down4)
    conv18_1 = BatchNormalization()(conv18)
    conv18_2 = Activation('relu')(conv18_1)
    conv19 = Conv2D(256, (7, 7), padding='same', kernel_initializer='he_normal')(down4)
    ...
    up1 = Conv2DTranspose(512, (3, 3), strides=2, padding='same', kernel_initializer='he_normal')(merge5)
    ...
    conv22 = Conv2D(128, (5, 5), padding='same', kernel_initializer='he_normal')(merge6)
    conv22_1 = BatchNormalization()(conv22)
    conv22_2 = Activation('relu')(conv22_1)
    conv23 = Conv2D(128, (7, 7), padding='same', kernel_initializer='he_normal')(merge6)
    ...
    up2 = Conv2DTranspose(256, (3, 3), strides=2, padding='same', kernel_initializer='he_normal')(merge7)
    ...
    conv26 = Conv2D(64, (5, 5), padding='same', kernel_initializer='he_normal')(merge8)
    conv26_1 = BatchNormalization()(conv26)
    conv26_2 = Activation('relu')(conv26_1)
    conv27 = Conv2D(64, (7, 7), padding='same', kernel_initializer='he_normal')(merge8)
    ...
    up3 = Conv2DTranspose(128, (3, 3), strides=2, padding='same', kernel_initializer='he_normal')(merge9)
    ...
    conv30 = Conv2D(32, (5, 5), padding='same', kernel_initializer='he_normal')(merge10)
    conv30_1 = BatchNormalization()(conv30)
    conv30_2 = Activation('relu')(conv30_1)
    conv31 = Conv2D(32, (7, 7), padding='same', kernel_initializer='he_normal')(merge10)
    ...
    up4 = Conv2DTranspose(64, (3, 3), strides=2, padding='same', kernel_initializer='he_normal')(merge11)
    ...
    conv34 = Conv2D(16, (5, 5), padding='same', kernel_initializer='he_normal')(merge12)
    conv34_1 = BatchNormalization()(conv34)
    conv34_2 = Activation('relu')(conv34_1)
    conv35 = Conv2D(16, (7, 7), padding='same', kernel_initializer='he_normal')(merge12)
