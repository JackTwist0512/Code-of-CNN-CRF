...
def CRFs(original_image_path,predicted_image_path,CRF_image_path):
    ...
    anno_lbl = anno_rgb[:,:,0] + (anno_rgb[:,:,1] << 8) + (anno_rgb[:,:,2] << 16)#<<表示移位符号，为左移
...
# CRFs("C:/Users/zjh/Desktop/test/img/0.png","C:/Users/zjh/Desktop/test/prd/0.png","C:/Users/zjh/Desktop/test/save/0.png")
