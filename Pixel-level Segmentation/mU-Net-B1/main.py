...
def main(m_class, train_num):
    ...
    if train:
        ...
        model = unet()
        model_path = test_path + "/model/"+type+"_binception3_1357"
        makedir(model_path)
        ...
        training_vis(history,test_path + "/model/"+type+"_binception3_1357/loss&acc" + str(n) + ".jpg")
    ...
    if predict:
        ...
        predict_save_path = test_path + "/predict/"+ type+"_binception3_1357/" + str(n)
